...
constexpr char CURRENT_FIRMWARE_TITLE[] PROGMEM = "ESP_OTA";
constexpr char CURRENT_FIRMWARE_VERSION[] PROGMEM = "0.0.2";
...
#elif defined(ESP32)
constexpr char WIFI_SSID[] PROGMEM = "TestECT";
constexpr char WIFI_PASSWORD[] PROGMEM = "07012023";
#endif

// See https://thingsboard.io/docs/getting-started-guides/helloworld/
// to understand how to obtain an access token
constexpr char TOKEN[] PROGMEM = "Cred17";

// Thingsboard we want to establish a connection too
constexpr char THINGSBOARD_SERVER[] PROGMEM = "192.168.0.111";
